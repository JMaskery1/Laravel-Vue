<script setup>
    ...
    const getInvoice = async() =>{ 
        ...
        //console.log('form', response.invoice)
    ...
    const deleteinvoiceItem = (id, i) => {
        ...
        if(id!= undefined) {
            axios.get('/api/delete_invice_items/'+id)
        }
    }
            ...
            <div class="card__content">
                ...
                <div class="table">
                    ...
                    <div class="table--items2" v-for="(itemcart, i) in form.invoice_items" :key="itemcart.id">
                        ...
                        <p style="color: red; font-size: 24px;cursor: pointer;" @click="deleteinvoiceItem(itemcart.id)">
                            &times;
                        </p>
                    </div>
            ...
            <div class="modal__content">
                ...
                <div class="modal__items">
                    <ul stlye="list-style:none;">
                        <li v-for="(item, i) in listproducts" :key="item.id" style="display:grid; grid-template-columns: 30px 250px 15px; align-items: center; padding-bottom: 5px">
                            <p>
                                {{ i+1 }}
                            </p>
                            <a href="#">{{item.item_code}} {{item.description}}</a>
                            <button @click="addCart(item)" style="border: 1px solid #e0e0e0; width: 35px; height: 25px; cursor: pointer;">
                                +
                            </button>
                        </li>
                    </ul>
